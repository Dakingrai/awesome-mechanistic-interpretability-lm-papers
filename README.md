...
| [Rethinking the Role of Scale for In-Context Learning: An Interpretability-based Case Study at 66 Billion Scale (ACL'23)](https://aclanthology.org/2023.acl-long.660.pdf) | Zero-Ablation | Faithfulness, Extrinsic | The paper discussed the importance of each component in an OPT-66B model across 14 tasks and found that some attention heads were task-agnostic. |
