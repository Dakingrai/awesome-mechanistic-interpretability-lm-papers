...
|  [Finding neurons in a haystack: Case studies with sparse probing (TMLR'23)](https://arxiv.org/pdf/2305.01610)  |      Probing    |   The paper proposes a sparse probing technique to localize a feature to a neuron or set of neurons in activations.    |
...
|  [Interpretability in the Wild: a Circuit for Indirect Object Identification in GPT-2 small (ICLR'23)](https://arxiv.org/pdf/2211.00593)  |      Mean-ablation, Path Patching    |   The paper proposes to use mean-ablation for activation and path patching.     |
...
|  [Towards Automated Circuit Discovery for Mechanistic Interpretability (NeurIPS'23)](https://arxiv.org/pdf/2304.14997)  |      ACDC    |   The paper introduces ACDC algorithm  to automate the iterative localization process.     |
...
|  [Attribution Patching Outperforms Automated Circuit Discovery (NeurIPS'23 ATTRIB)](https://arxiv.org/pdf/2310.10348)  |      Edge Attribution Patching (EAP)    |   The paper introduces Edge Attribution Patching (EAP) as a more efficient alternative to ACDC for automatically identifying circuits.     |
